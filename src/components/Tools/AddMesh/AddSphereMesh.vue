<template>
    ...
    <div class="d-flex flex-column mb-6">
        ...
        <v-text-field label="Diameter X" variant="solo" class="ml-4 mr-4"
            :rules="[v => isValid(v, 0) || 'Must be a number and greater than 0']"></v-text-field>
        <v-text-field label="Diameter Y" variant="solo" class="ml-4 mr-4"
            :rules="[v => isValid(v, 0) || 'Must be a number and greater than 0']"></v-text-field>
        <v-text-field label="Diameter Z" variant="solo" class="ml-4 mr-4"
            :rules="[v => isValid(v, 0) || 'Must be a number and greater than 0']"></v-text-field>
